...
DOMAIN_BASE = 'lvh.me'
SESSION_COOKIE_DOMAIN = f"{DOMAIN_BASE}"
ALLOWED_HOSTS = [
...
CSRF_COOKIE_SECURE = False           # Must be False on localhost
...
CSRF_TRUSTED_ORIGINS = [
    'http://localhost:8000',
    'http://*.localhost:8000',
    'https://hbkfb9hh-8000.asse.devtunnels.ms', # <-- Add your specific tunnel link here
]
