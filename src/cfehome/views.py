...
def LandingPageView(request):
    ...
    context = { 'is_main_domain': is_main_domain, 'subdomain': request.subdomain, 'error_message': error_message, "main_host_url": f'https://{settings.MAIN_SUBDOMAIN}.scalesphere.space' }
